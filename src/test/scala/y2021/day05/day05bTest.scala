...
import y2021.day05.day05b.{Line, countPoints, parseInput, pointsWithCount}
...
class day05bTest {
  ...
  @Test
  def aDiagonalLine():Unit = {
    val line = Line((1,3), (3,5))

    assertEquals(List((1,3), (2,4), (3,5)), line.expand)
  }

  @Test
  def anInvertedDiagonalLine():Unit = {
    val line = Line((3,5), (1,3))

    assertEquals(List((3,5), (2,4), (1,3)), line.expand)
  }
  ...
  def pointsWithCountAtLeastTwoIsCorrect(): Unit = {
    ...
    assertEquals(12, pointsWithCount(points))
  }
